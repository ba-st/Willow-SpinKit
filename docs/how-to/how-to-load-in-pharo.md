# How to load Willow SpinKit in a Pharo image
...
4. Evaluate:
    ...
    Metacello new
      ...
      repository: 'github://ba-st/Willow-SpinKit:release-candidate';
      load: 'Development'.
    ```
...
5. Select *Clone from github.com* and enter `ba-st` as owner name and `Willow-SpinKit`
   as project name
6. Click *Ok*
7. Select the repository in the main Iceberg window
8. Open the contextual menu and select
  *Metacello -> Install baseline of Willow-SpinKit ...*
